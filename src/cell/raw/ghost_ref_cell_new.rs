...
//! Provides better performance under contention than std::cell::RefCell.
//!
//! ## Performance Characteristics
//!
//! - **Borrow/BorrowMut**: O(1) - optimized atomic operations with better contention handling
//! - **Access**: O(1) - direct pointer dereference
//! - **Memory**: Optimized layout with better cache locality
//! - **Thread Safety**: Multi-threaded safe with atomic borrow counting
//! - **Contention**: Significantly better performance under high contention
//!
//! ## Safety Invariant
//!
